...
if __name__ == '__main__':
    ...
    image = common.read_imgfile(args.image, None, None)  # bunun yerine kamerayı kullanıcaz
    ...
    for human in humans:
        ...
        pose_2d_mpiis.append([(int(x * standard_w + 0.5), int(y * standard_h + 0.5)) for x, y in pose_2d_mpii])  # all keypoints
